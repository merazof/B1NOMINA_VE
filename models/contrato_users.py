'''
Modelo que define a la tabla  Contrato del usuario
Created 2024-04
'''
...
class ContratoUsuarios(Base):
	...
	CONSTRAINT `FK_Usuario_ContratoUsuarios` FOREIGN KEY (`user_id`) REFERENCES `Usuario` (`id`) ON UPDATE CASCADE
    '''
    __tablename__="ContratoUsuarios"
