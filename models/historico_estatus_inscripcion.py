'''
Modelo que define a la tabla  Historico estatus de inscripcion del usuario
Created 2024-04
'''
...
class HistoricoEstatusInscripcion(Base):
    '''
...
-- ----------------------------------------------
	...
	PRIMARY KEY (`id`)
    '''
    __tablename__="HistoricoEstatusInscripcion"
    id = Column(BIGINT, primary_key=True, autoincrement=True)
    estatus_inscripcion_id= Column(BIGINT,  unique=True)
